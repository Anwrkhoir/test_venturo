                ...
                <form action="" method="get">
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <a href="/api/laporanpenjualan" target="_blank" rel="Array Menu" class="btn btn-secondary">
                                Json Menu
                            </a>
                            <a href="/api/datatransaksi" target="_blank" rel="Array Transaksi" class="btn btn-secondary">
                                Json Transaksi
                            </a>
                        </div>
                    </div>
